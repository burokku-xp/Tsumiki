...
2. **Branch management**: Switch from `develop` branch to a development branch (e.g., `feature/<change-id>` or similar) before starting implementation.
3. Work through tasks sequentially, keeping edits minimal and focused on the requested change.
4. **Commit strategy**: Make appropriate commits at suitable intervals during implementation to track progress.
